...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-dw", "--dont_write_to_table",
        action="store_false",
        help="Disable Writing the OFS forecasts to table. Defaults to True. Run '--dont_write_to_table' to Disable."
    )
    args = parser.parse_args()

    logger.info("Starting the Inference pipeline...")
    inference_pipeline(args.model_type, args.ticker, args.dont_write_to_table)
